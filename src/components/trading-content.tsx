...
const myOrders = [
  { id: 1, type: "buy", price: 247.0, quantity: 100, filled: 0, status: "open", time: "2024-01-15 10:30" },
  { id: 2, type: "sell", price: 252.0, quantity: 50, filled: 25, status: "partial", time: "2024-01-15 09:15" },
  { id: 3, type: "buy", price: 245.5, quantity: 200, filled: 200, status: "filled", time: "2024-01-14 16:45" },
]
    ...
    <div className="max-w-7xl mx-auto space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground mt-2">Buy and sell real estate tokens on the secondary market</p>
        </div>
        ...
        <Select value={selectedAsset} onValueChange={setSelectedAsset}>
          ...
          <SelectContent>
            <SelectItem value="manhattan-apt">Manhattan Luxury Apartment</SelectItem>
            <SelectItem value="miami-condo">Miami Beach Condo</SelectItem>
            <SelectItem value="austin-complex">Austin Residential Complex</SelectItem>
          </SelectContent>
        </Select>
      </div>
                  ...
                  <div className="space-y-2">
                    <div className="flex justify-between text-sm">
                      ...
                      <span className="font-medium">
                        $
                        {price && quantity
                          ? (Number.parseFloat(price) * Number.parseFloat(quantity)).toFixed(2)
                          : "0.00"}
                      </span>
                    </div>
                    <div className="flex justify-between text-sm">
                ...
                {myOrders.map((order) => (
                  <tr key={order.id} className="border-b">
                    ...
                    <td className="py-3">
                      <Badge
                        variant={
                          order.status === "filled" ? "default" : order.status === "partial" ? "secondary" : "outline"
                        }
                      >
                        {order.status}
                      </Badge>
