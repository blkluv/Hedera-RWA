  ...
  return (
    <div className="max-w-7xl mx-auto space-y-8">
      <div>
        ...
        <p className="text-muted-foreground mt-2">Track your real estate investments and earnings</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{portfolioData.monthlyIncome}</div>
            <p className="text-xs text-muted-foreground">From dividend payments</p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">Across {portfolioData.tokens.toLocaleString()} tokens</p>
          </CardContent>
        </Card>
                ...
                <div className="flex-1">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-4">
                    <div>
                      ...
                      <p className="font-medium">{holding.tokens.toLocaleString()}</p>
                    </div>
                    <div>
                    ...
                    <div>
                      ...
                      <p className="font-medium text-green-600">{holding.gain}</p>
                    </div>
                    <div>
              ...
              <div key={holding.id} className="flex items-center justify-between p-3 border rounded">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Monthly dividend payment</p>
                  </div>
                </div>
                <div className="text-right">
                  <p className="font-medium text-green-600">{holding.lastDividend}</p>
                  <p className="text-xs text-muted-foreground">Next: {holding.nextDividend}</p>
                </div>
              </div>
            ))}
          </div>
